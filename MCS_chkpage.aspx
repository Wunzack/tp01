<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MCS_chkpage.aspx.cs" Inherits="ecsfc.MCS_chkpage" %>
...
<link href="Content/machChkSysStyles/mcsChkpageStyle.css" rel="stylesheet" />
</head>
...
<div id="imgInput" style="display:none;"><input id='InputImg' type="file" onchange="previewFile()"/><span>或</span><input id="imgurImg" type="text" placeholder="貼上imgur"/><div class='form-group'><span>機號：</span><input id="machID" list="machList" name="browser" placeholder="請輸入機號"/>
  ...
  <div class="outlayer">
    ...
    <div id="chklistInner" class="chklistInner">
      <div id="chkContent" class="chkContent">
          ...
          <div id="dtSecOutLay">
                <div id="dataSection" class="dataSection"></div>
          </div>        
      </div>
  </div>
</div>
</div>
      <div id="timeTickLayer">
          <div id="chkFunLeaveBtn">離開</div>
          <div id="errorDescBlock">
              <div id="errDesc" contenteditable="true"></div>
              <div id="errBtnHover">
                    <div id="errMsgSend" onclick="sendEvt()" class="errDeBlocBtn btn_purple">傳送</div>
                    <div id="cancel" onclick="cancelEvt()" class="errDeBlocBtn btn_blue">取消</div>
              </div>              
</div>
                    <div id="countNumLay">200</div>
          <div id="contentLay">
              <div class="cLayRow"></div>
          </div>
          <div id="ctrlElesLay">
              <div class="cLayRow marginType"><div id="stpBtn" class="btn btn_blue" status="0">開始</div></div>
              <div class="cLayRow marginType"><div id="finBtn" class="btn btn_green">結束</div></div>
              <div class="cLayRow marginType"><div id="errBtn" class="btn btn_red">回報異常</div></div>
          </div>
...
<%--<script src="Scripts/jquery-1.9.1.js"></script>--%>
    ...
    <script src="Scripts/mcsJS/index2.js"></script>
    <script src="Scripts/mcsJS/mcsHomeCtrl.js"></script>
    <script src="Scripts/mcsJS/MCS_chkpageMJ.js"></script>
